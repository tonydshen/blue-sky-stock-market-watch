...
#
# Concise version requirements, 09/21/2026:
# 1. Lock the first column (Symbol) in the HTML report so it stays visible when scrolling horizontally.
#
...
<div class="wrap">
  ...
  <p class="hint">Click a column header to sort; click again to reverse. The Direction column isn't sortable. The Symbol column stays put when the table scrolls sideways.</p>
